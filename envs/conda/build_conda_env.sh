...
#
# This script builds a Conda environment based on the provided name or the default 'spatial-adapter'.
#
# Parameters:
#   -c, --conda_env       Specifies the name of the Conda environment (default: 'spatial-adapter')
#
# Examples:
#   1. Build the default Conda environment 'spatial-adapter':
#       ./build_conda_env.sh
#
